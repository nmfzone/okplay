...
public class Generator
{
    ...
    protected String replaceStubName;
        ...
        try {
            ...
            if (! _p2.equals("-") && ! _p2.equals("")) {
                if (_p2.equals("make:controller")) {
                    ...
                    g.replaceStubName = "Controller_Stub_Name|" + _p3;
                    ...
                    String _p3_plural = _p3;
                    _p3_plural = English.plural(_p3_plural).toLowerCase();

                    g.replaceTableName = "Model_Table_Name|" + _p3_plural;
                    g.replaceStubName = "Model_Stub_Name|" + _p3;
            ...
            if (! _p7.equals("-") && ! _p7.equals("")) g.replaceStubName = _p7;
            ...
            if (_p2.equals("") || _p2.equals("-h") || _p2.equals("--help")) {
                ...
                // Handle replace Table Name
                if (_p2.equals("make:model")) {
                    String[] replTbNm = g.replaceTableName.split("\\|");
                    stubContents = stubContents.replaceAll(replTbNm[0], replTbNm[1]);
                }

                // Handle replace Stub Name
                String[] replStNm = g.replaceStubName.split("\\|");
                targetContents = stubContents.replaceAll(replStNm[0], replStNm[1]);

                // Write final stub to the target
